...
var Indicator = function (_PureComponent) {
	...
	_createClass(Indicator, [{
		...
		value: function render() {
			...
			var cases = _cases(isActive, { complete: complete, warning: warning, error: error, disabled: disabled });
			...
			if (!lead) {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						"div",
						{ className: "react-wizard-indicator-circle", onClick: onClick.bind(null, index) },
						_react2.default.createElement(
							"span",
					...
					switch (validationResult) {
						case 0:
							cumulativeEndState = _extends({}, cumulativeEndState, {
								steps: Object.assign([], cumulativeEndState.steps, _defineProperty({}, i, { complete: false, warning: false, error: true, disableNext: true }))
							});
							break;
						case 1:
							cumulativeEndState = _extends({}, cumulativeEndState, {
								current: cumulativeEndState.current + 1,
								steps: Object.assign([], cumulativeEndState.steps, _defineProperty({}, i, { complete: true, warning: false, error: false, disableNext: false }))
							});
							break;
						case 2:
							cumulativeEndState = _extends({}, cumulativeEndState, {
								current: cumulativeEndState.current + 1,
								steps: Object.assign([], cumulativeEndState.steps, _defineProperty({}, i, { complete: true, warning: true, error: false, disableNext: false }))
							});
							break;
					}
				}
	...
	_createClass(ReactWizard, [{
		...
		value: function render() {
			...
			var _props = this.props,
			    ...
			    onIndicatorClick = _props.onIndicatorClick,
			    style = _props.style,
			    rest = _objectWithoutProperties(_props, ["steps", "currentStep", "indicatorProperties", "currentStepTitle", "currentStepSubheading", "children", "onIndicatorClick", "style"]);
