...
var ConditionalRenderWrapper = function (_PureComponent) {
	...
	function ConditionalRenderWrapper(props) {
		...
		_this.createSteps = _this.createSteps.bind(_this);
		return _this;
	}
	...
	_createClass(ConditionalRenderWrapper, [{
		...
		key: "createSteps",
		value: function createSteps(stepsData) {
		...
		value: function render() {
			...
			var _props = this.props,
			    ...
			    rest = _objectWithoutProperties(_props, ["id", "children", "loadingSpinner", "hydrateState", "onCompleteFunc", "afterCompleteComponent"]);
...
var Step = function Step(props) {
	...
	return _react2.default.createElement(
		"div",
		{ id: id, className: (0, _utils.applyClasses)(_classListArray, cases, "react-wizard-step " + className) },
		children,
		_react2.default.createElement(
			"div",
