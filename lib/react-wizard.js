...
var _reactWizard = __webpack_require__(6);
...
var Header = function Header(props) {
	var totalSteps = props.totalSteps,
	    ...
	    currentStepStatus = props.currentStepStatus,
...
var ReactWizard = function ReactWizard(props) {
	var totalSteps = props.totalSteps,
	    ...
	    rest = _objectWithoutProperties(props, ["totalSteps", "currentStep", "currentStepStatus", "currentStepTitle", "currentStepSubheading", "children"]);

	var cases = _cases(currentStepStatus);
